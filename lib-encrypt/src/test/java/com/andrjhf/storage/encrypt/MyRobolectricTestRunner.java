...
public class MyRobolectricTestRunner extends RobolectricTestRunner {
    ...
    protected AndroidManifest getAppManifest(Config config) {
        String projectName = "StorageEncrypt";
        ...
        String manifestProperty = rootPath + "/library/src/main/AndroidManifest.xml";
        String resProperty = rootPath + "/library/src/main/res";
        String assetsProperty = rootPath + "/library/src/main/assets";
